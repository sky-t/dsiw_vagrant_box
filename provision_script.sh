...
aptitude -f install -y grass >> $LOGFILE
echo 'Installing gdal'
aptitude -f install -y gdal-bin >> $LOGFILE
echo 'Installing qgis w/ grass...'
aptitude -f install -y qgis python-qgis qgis-plugin-grass >> $LOGFILE
